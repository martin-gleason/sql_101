...
* **Constraints:** Keys, Can be Null, Autoupdating...
...
* WHERE 
  * `SELECT * FROM table`
.highlight[WHERE]`   column >= value;`

--
* Logical Operators 

`SELECT  table1.column1, table1.column2,` <br> `table2.column2,table3.column3 `
...
*Drop is used to delete tables and columns 

--
.highlight[`DROP`] `TABLE tablename;`

--
*Delete is used to delete specific rows (records)
